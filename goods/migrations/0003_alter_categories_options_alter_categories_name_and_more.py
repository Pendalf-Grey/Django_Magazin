...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('goods', '0002_alter_categories_name_alter_categories_slug_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=7, verbose_name='Стоимость товара')),
